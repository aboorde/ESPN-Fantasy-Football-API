 ...
 * @augments {BaseObject}
 */
declare class Matchup extends BaseObject {
    /**
    ...
    static responseMap: {
        /**
         * The matchup's id on the schedule.
         */
        id: number;
        /**
         * The matchup period the matchup is played in.
         */
        ...
        homeTeamId: number;
        /**
         * The total points scored by the home team, live where ESPN is
         * scoring the matchup now.
         */
        homeScore: number;
        /**
         * ESPN's live probability the home team wins, from 0 to 1.
         * NOTE: Only populated for the current matchup period.
         */
        homeWinProbability: number;
        /**
         * The away team's id. Can be used to load a cached Team. Absent on
         * a bye, which leagues with an odd number of teams will have.
         */
        awayTeamId: number;
        /**
         * The total points scored by the away team, live where ESPN is
         * scoring the matchup now.
         */
        awayScore: number;
        /**
         * ESPN's live probability the away team wins, from 0 to 1.
         * NOTE: Only populated for the current matchup period.
         */
...
type MatchupAttributes = typeof Matchup.responseMap;
interface Matchup extends MatchupAttributes {}
